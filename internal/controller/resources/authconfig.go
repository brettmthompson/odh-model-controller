...
type AuthConfigTemplateLoader interface {
	Load(ctx context.Context, authType AuthType, protectedResource client.Object) (authorinov1beta3.AuthConfig, error)
}
...
func (s *staticTemplateLoader) Load(_ context.Context, authType AuthType, protectedResource client.Object) (authorinov1beta3.AuthConfig, error) {
...
func (c *configMapTemplateLoader) Load(ctx context.Context, authType AuthType, protectedResource client.Object) (authorinov1beta3.AuthConfig, error) {
